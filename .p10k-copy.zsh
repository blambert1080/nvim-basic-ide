# Generated by Powerlevel10k configuration wizard on 2026-05-13 at 09:31 CDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_SUBSEGMENT_SEPARATOR=
  typeset -g POWERLEVEL9K_LEFT_SEGMENT_SEPARATOR='\uE0B0'
  typeset -g POWERLEVEL9K_LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL='%F{#3c6581}\uE0B4%f'
  typeset -g POWERLEVEL9K_LEFT_PROMPT_FIRST_SEGMENT_START_SYMBOL='\uE0B6'
  typeset -g POWERLEVEL9K_EMPTY_LINE_LEFT_PROMPT_LAST_SEGMENT_END_SYMBOL=
  ...
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_BACKGROUND=30
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE=' %n@%m '
  ...
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND=66
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND=66
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND=239
  typeset -g POWERLEVEL9K_VCS_LOADING_BACKGROUND=31
  # ===================== Search for and set these ============================
    # Styling for different parts of Git status.
    # local       meta='%7F' # white foreground
    # local      clean='%7F' # black foreground
    # local   modified='%7F' # black foreground
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND=050
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_SUFFIX=' '

  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_FOREGROUND=235
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_BACKGROUND=51
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_SUFFIX=' '

  typeset -g POWERLEVEL9K_TIME_BACKGROUND=195
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=007
  typeset -g POWERLEVEL9K_TIME_FORMAT='%K{#3c6581} %D{%I:%M %p} %k'
  typeset -g POWERLEVEL9K_TIME_VISUAL_IDENTIFIER_EXPANSION=
  typeset -g POWERLEVEL9K_TIME_PREFIX='%K{51}%F{195}%K{45}%F{51}%K{#3c6581}%F{45}%k%f'
